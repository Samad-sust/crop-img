...
image_dir = "/home/samad/Desktop/Images/Main Images"

# the place where the imaged get saved 
cropped_image_dir = "/home/samad/Desktop/Images/cropped"
...
for i, image in enumerate(imagefiles):
    ...
    cropped_img.save(f"{cropped_image_dir}/{image.split(sep='/')[-1]}")